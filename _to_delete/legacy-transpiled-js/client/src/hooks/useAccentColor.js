...
import { DEFAULT_ACCENT, derivePalette, quantizeDominant, } from '../lib/color';
/**
 ...
 */
export function useAccentColor(coverUrl, trackId) {
    ...
    const [ready, setReady] = useState(() => (coverUrl ? colorCache.has(coverUrl) : true));
